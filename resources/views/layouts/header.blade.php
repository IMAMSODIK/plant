<div class="page-header">
    <div class="header-wrapper row m-0">
        ...
        <div class="left-header col-xxl-5 col-xl-6 col-lg-5 col-md-4 col-sm-3 p-0">
            ...
            <div class="welcome-content d-xl-block d-none"><span class="text-truncate col-12">Manage all your plants
                    easily within this application</span></div>
        </div>
            ...
            <ul class="nav-menus">
                ...
                <li class="onhover-dropdown notification-down">
                    <div class="notification-box">
                        ...
                        <span id="notif-count" class="badge rounded-pill badge-secondary">0</span>
                    </div>
                        ...
                        <div class="card mb-0">
                            <div class="card-header">
                                <div class="common-space">
                                    ...
                                    <div><span id="notif-count-text">0 New</span></div>
                                </div>
                            </div>
                            <div class="card-body">
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="media profile-media">
                        <img class="b-r-10" src="{{ asset('dashborad_assets/assets/images/dashboard/profile.png') }}"
                            alt="">
